...
public class List<E> {
	...
	/*Returns a list containing elements, including
	 nIndex and excluding n2Index. The first parameter
	 indicates the nIndex and the second parameter
	...
	public List subList(int n, int n2) {
		...
		List l1 = new List();
		try {
			E[] sample = (E[])new Object[n2 - n];
			System.arraycopy(list, n, sample, 0, n2 - n);
			l1.addAll(sample);
			return l1;
		} catch (Exception e) {
