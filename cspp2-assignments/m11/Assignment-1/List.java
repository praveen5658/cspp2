...
public class List {
    ...
    */
    ...
    /*
     * Get method has to return the newArray that is at the index position passed
     ...
     * the number of newArray in the list then that would mean the item doesn't
     ...
     *
     * So, implement the toString method to display the newArray in the list in the
     ...
     * Example: [1,2,3,0,0,0,0,0,0,0] toString should only return the newArray in
